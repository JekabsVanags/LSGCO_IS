...
RSpec.describe PersonalInformationController, type: :controller do
  ...
  describe 'GET #edit' do
    it 'assigns the user\'s personal information and renders the edit template' do
  ...
  describe 'GET #show' do
    it 'assigns the user\'s personal information and renders the show template' do
      personal_info = create(:personal_information, user: user)
      get :show
      expect(assigns(:info)).to eq(personal_info)
